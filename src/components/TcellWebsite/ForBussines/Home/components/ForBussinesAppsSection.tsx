...
import { IForBussinesAppsSectionProps } from '../lib/types/IForBussinessHomePageTypes'
import Title from '@/components/Ui/Title/Title'
import ProductCard from '@/components/Ui/Cards/Product/ProductCard'
import clsx from 'clsx'

const ForBussinesAppsSection = ({className}:IForBussinesAppsSectionProps) => {
...
export default ForBussinesAppsSection